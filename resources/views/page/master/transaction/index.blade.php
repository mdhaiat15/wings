        ...
        <div class="flex flex-col-reverse md:flex-row">
            ...
            <div class="flex-auto">
                ...
                <div
                    ...
                    <form action="{{ route('transaction.print') }}" method="POST">
                        @csrf
                        <div class="flex justify-end p-4">
                            <div class="px-2">
                                <input class="form-control" name="{{ 'date' }}1" type="date">
                                <input class="form-control" name="{{ 'date' }}2" type="date">
                            </div>
                            <div class="bg-indigo-600 px-4 flex justify-center items-center rounded-lg">

                                <button type="submit"
                                    class="flex-1 text-white text-left text-lg font-medium overflow-hidden whitespace-nowrap overflow-ellipsis">Print</button>
                            </div>
