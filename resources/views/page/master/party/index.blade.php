    ...
    <x-main-container>
        ...
        <div class="flex flex-col-reverse md:flex-row">
            ...
            <div class="flex-auto">
                ...
                {{-- panel --}}
                <div class="mb-5 bg-[var(--app-white)] dark:bg-[var(--app-white-dark)] rounded-md shadow border border-transparent">
                        ...
                        <div class="w-full relative overflow-x-auto">
                            ...
                            <table class="w-full text-left text-[14px] border-collapse">
                                ...
                                <thead class="capitalize ">
                                    <tr class="border-b border-[var(--app-gray-10)] dark:border-[var(--app-gray-10-dark)]">
